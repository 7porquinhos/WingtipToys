...
public class NVPAPICaller
{
    ...
    public string APIUsername = "WingtipToysDeveloper-Teste_api1.live.com";
    private string APIPassword = "9JHVGG6GSULFQLMB";
    private string APISignature = "AdO29Aukyo1rnZ5e.kEPL5kX4z-OAs-lyEGTb2SBzE4l6NORW5LUjvL0";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        using (WingtipToys.Logic.ShoppingCartActions myCartOrders = new WingtipToys.Logic.ShoppingCartActions())
        {
            ...
            for (int i = 0; i < myOrderList.Count; i++)
            {
                ...
                encoder["L_PAYMENTREQUEST_0_AMT0" + i] = myOrderList[i].Product.UnitPrice.ToString();
